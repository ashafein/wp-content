...
$meta_boxes = array(
    'Product' => array(
        'name' => '_area',
        'title' => __('Area', 'hb'),
        'description' => __('Enter area of property', 'hb'),
    ),
    'Paypal' => array(
        'name' => '_bedroom',
        'title' => __('Bed Room:', 'hb'),
        'description' => __('Enter numbers of bedrooms', 'hb')
    ),
    'ThankURL' => array(
        'name' => '_price',
        'title' => __('Price', 'hb'),
        'description' => __('Enter price of property.', 'hb')
    ),
    'CancelURL' => array(
        'name' => '_city',
        'title' => __('City', 'hb'),
        'description' => __('Enter your city.', 'hb')
    ),
    'ProductPrice' => array(
        'name' => '_location',
        'title' => __('Location', 'hb'),
        'description' => __('Enter your property location', 'hb')
    ),
);

//if (get_option('gamio_submit_how_to_play_display')=='yes') :
/* $play_meta_boxes = array('How to Play' => array(
  'name' => 'gamio_how_to_play',
  'title' => __('How to Play', 'gamio'),
  'description' => __('Details on how to play to the game.', 'figero'),
  'type' => 'textarea'
  ));
  $meta_boxes = array_merge($meta_boxes, $play_meta_boxes);
 */
//endif;
...
function create_meta_box() {
    ...
    if (function_exists('add_meta_box'))
        add_meta_box('new-meta-boxes', __('Property Meta', 'hb'), 'display_meta_box', 'post', 'normal', 'high');
}
