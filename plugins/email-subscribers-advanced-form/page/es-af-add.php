...
if ( !is_plugin_active( 'email-subscribers/email-subscribers.php' ) ) 
{
	...
	_x('This is a add-on plugin for Email Subscribers plugin. This will extend the Email Subscribers plugin Subscribers Form functionality. Please note, Email Subscribers Advanced Form plugin works only if you have activated Email Subscribers plugin first.', 'es-af-add' ,ES_AF_TDOMAIN);
	echo "</strong></p></div>";
