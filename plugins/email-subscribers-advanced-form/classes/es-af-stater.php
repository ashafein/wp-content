...
if(!defined('ES_AF_PLUGIN_DISPLAY')) define('ES_AF_PLUGIN_DISPLAY', "Email Subscribers Advanced Form");
...
if(!defined('ES_AF_FAV')) define('ES_AF_FAV', 'http://www.storeapps.org/support/contact-us/');
define('ES_AF_OFFICIAL', 'If you like <strong>Email Subscribers Advanced Form</strong>, please leave us <a target="_blank" href="https://wordpress.org/support/view/plugin-reviews/email-subscribers-advanced-form?filter=5#postform">&#9733;&#9733;&#9733;&#9733;&#9733;</a> a rating. A huge thank you from StoreApps in advance!');

require_once(ES_AF_DIR.'classes'.DIRECTORY_SEPARATOR.'es-af-register.php');
require_once(ES_AF_DIR.'classes'.DIRECTORY_SEPARATOR.'es-af-query.php');
