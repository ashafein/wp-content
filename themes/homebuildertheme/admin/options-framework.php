...
if (!function_exists('optionsframework_page')) {
    ...
    <h1>Go PREMIUM!</h1>
    <p>You are using the free trial version of HomeBuilder. Upgrade to HomeBuilder Premium for fully functional theme with extra features, lifetime theme updates, dedicated support, and comprehensive theme tutorials.
      </p>
        <a href="http://www.inkthemes.com/wp-themes/" target="blank">Buy the fully functional HomeBuilder Premium Wordpress Theme ?</a>  
</div>
        <div class="wrap">    
